...
class Assignment { //Not sure we need the WP_User class, but it could be helpful.
	...
	public function get_grades(){
		...
		$this->grades = maybe_unserialize( get_user_meta( $this->sid, 'student_grades', true ) );	
	 ...
	 * @since 0.1
	 *
	 * Called in: templates/asignment-editor.php, line 124, func/admin_metaboxes.php, line 219.
	 **/
	...
	public function update_grade( $asmt_update ){
		...
		// $msg = new Message();
		// $message = "The update_grade method has been called in the asmt Class. ASMT KEY is $asmt_key and the ASMT STATUS is $asmt_status . ". print_r( $asmt_update, TRUE );	
		// $msg->admin_notice( 'Test from ASMT class, line 206', $message );
		...
		if( isset( $asmt_key ) ){
			...
			$msg->admin_notice( 'Test from ASMT class, line 218', $message ); */
	 ...
	 * GET_ASMT_POST_INFO 
	 * 
	 * Descrip: This searches for the specific ID of a given user submitted assignment type course CPT. 
	 *
	 * Parameters: 
	 *
	 * @since 0.1
