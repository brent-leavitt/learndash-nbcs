...
//Sandbox?
$ipn_sandbox = ( strcmp( 'postpartum', substr( $_SERVER[ 'HTTP_HOST' ], 0, 10 ) ) == 0 )? true : false ;
...
function sort_ipn( array $ipn_data ){
		...
		$biz_email = ( $ipn_data[ 'ipn_sandbox' ] )? "testbiz1@trainingdoulas.com" : "office@trainingdoulas.com" ; //True= sandbox, False = live. 
